...
5.  What are the data types of the three variables used for aesthetic mappings?
    ...
    X-axis, Y-axis, and color

    ```{r}
    ggplot(data = gapminder_2007, aes(x = continent, y = lifeExp, fill = continent)) +
      geom_boxplot(outlier.shape = NA) +  # NA removes outliers
      labs(title = "Boxplot of Life Expectancy by Continent (2007)",
           x = "Continent",
           y = "Life Expectancy")

    #AI tool: https://chat.openai.com/share/5279ff72-cafc-4bfe-95f4-7c881f0e1b0f
    ```
